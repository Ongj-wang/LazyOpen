...
echo [2/4] Removing temporary build directory...
if exist "build" rmdir /s /q "build"

echo [3/4] Adding the dist directory to the user PATH...
set "LAZYOPEN_PROJECT_DIR=%PROJECT_DIR%dist"
...
echo [4/4] Registering PowerShell tab completion...
set "LAZYOPEN_COMPLETION=%PROJECT_DIR%lazyopen-completion.ps1"
